...
import no.kartverket.serg.mock.infrastructure.FeilException
import no.kartverket.serg.mock.infrastructure.SergValidationError
import no.kartverket.serg.mock.validation.V
import no.kartverket.serg.mock.validation.asInt
import no.kartverket.serg.mock.validation.asIsoLocalDate
import no.kartverket.serg.mock.validation.asLong
import no.kartverket.serg.mock.validation.default
import no.kartverket.serg.mock.validation.nonBlank
import no.kartverket.serg.mock.validation.positive
import no.kartverket.serg.mock.validation.refine
import no.kartverket.serg.mock.validation.required
import no.kartverket.tjenestespesifikasjoner.serg.hendelser.models.Hendelser
import no.kartverket.tjenestespesifikasjoner.serg.hendelser.models.Start
...
internal fun Route.registerSergRoutes(store: MockDataStore) {
    get("/hendelser") {
        val fraSekvensnummer: Long = call
