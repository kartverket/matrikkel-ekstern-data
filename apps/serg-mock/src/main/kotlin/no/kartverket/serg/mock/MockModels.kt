...
internal data class GeneratedRow(
    val hendelse: no.kartverket.tjenestespesifikasjoner.serg.hendelser.models.Hendelse,
    val formuesobjekt: no.kartverket.tjenestespesifikasjoner.serg.formueobjekt.models.FastEiendomSomFormuesobjekt,
